...
The XR icon indicates sources that only contribute to the eXtended Release. You can choose to include or exclude these sources from the list using the checkbox beside the XR icon. Read about the [different releases]/building/releases COL provides. 
