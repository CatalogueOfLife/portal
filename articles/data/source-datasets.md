...
The data in the current <a href="/data/metadata">version {{site.metadata_base.current.version}}</a> of the COL Checklist have been provided by the resources listed below.
