...
<style>
  /* Past-releases table: use the regular body text colour (#444) rather than
     Foundation's grey table styling (it colours cells with $jet = #999). */
  .prose table th,
  .prose table td { color: #444; }
</style>
