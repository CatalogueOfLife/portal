...
class PublicTree extends React.Component {
    ...
    render() {
      ...
      return e(
        ColBrowser.Tree,
        { catalogueKey: '{{ site.react.datasetKey }}' , pathToTaxon: '{{ site.react_xcol.pathToTaxon }}', pathToDataset: '{{ site.react_xcol.pathToDataset }}' , auth: '{{ site.react.auth }}', showTreeOptions: true}
      );
    }
  }
