...
export const milestones: Milestone[] = [
  ...
  // tile's full TAXON_ID set). "Other kingdoms" links to Chromista (C) as its
  // representative taxon (Protozoa's page renders empty). The version-aware
  // href is applied client-side from the data-taxon-id (see Header.astro).
  ...
  { image: 'Protozoa.jpg', title: 'Other kingdoms', bgcolor: '2db261', fgcolor: 'ecf7ef', link: '/data/taxon/C', query: `TAXON_ID=V&TAXON_ID=R&TAXON_ID=B&TAXON_ID=C&TAXON_ID=Z&${speciesQuery}` },
];
