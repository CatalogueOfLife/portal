...
import importHistory from '../../assets/posts/import-history.png';
...
<Image src={importHistory} widths={[480, 960, 1400]} sizes="(max-width: 1000px) 100vw, 1000px" format="webp" alt="ChecklistBank import history view" />
