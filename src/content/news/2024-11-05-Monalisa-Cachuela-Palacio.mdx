...
import monalisa from '../../assets/posts/Monalisa.JPG';
...
<Image src={monalisa} widths={[480, 800, 1200]} sizes="(max-width: 800px) 100vw, 800px" format="webp" alt="Monalisa Cachuela-Palacio" />
